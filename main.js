...
document.querySelector('.popover_btn').addEventListener('click', () => {
  (0,_popover__WEBPACK_IMPORTED_MODULE_0__["default"])(popoverTitle, popoverContent, popoverOnElement);
});
...
/* harmony export */   "default": function() { return /* binding */ addPopover; }
/* harmony export */ });
function addPopover(popoverName, popoverContent, popoverOnElement) {
  ...
  if (!document.contains(popover)) {
    ...
    const {
      left,
      top
    } = popoverBtn.getBoundingClientRect();
